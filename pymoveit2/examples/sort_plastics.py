...
class PickAndPlace(Node):
    def __init__(self):
        ...
        self.pre_pick_joints_obj1 = [
            math.radians(34), math.radians(86), math.radians(0),
            math.radians(-23), math.radians(0),
            math.radians(113), math.radians(80)
        ]

        self.pre_pick_joints_obj2 = [
            math.radians(23), math.radians(66), math.radians(0),
            math.radians(-48), math.radians(0),
            math.radians(110), math.radians(0)
        ]

        self.pre_pick_joints_obj3 = [
            math.radians(-31), math.radians(87), math.radians(0),
            math.radians(-4), math.radians(15),
            math.radians(106), math.radians(0)
        ]
    ...
    def execute_sequence(self):
        ...
        self.moveit2.move_to_configuration(self.pre_pick_joints_obj3)
        self.moveit2.wait_until_executed()
        ...
        self.moveit2.move_to_configuration(
            self.home_with_joint1(self.pre_pick_joints_obj3[0])
        )
        self.moveit2.wait_until_executed()
